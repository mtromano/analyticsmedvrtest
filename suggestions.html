				...
				<div class ="sidebar">
					<div class = "logo"><h1>Analytics</h1></div>
						<ul>
							<li>
								<div class= "rectangle" >
									<a href="https://mtromano.github.io/analyticsmedvrtest/home.html" class="inactive"><h4><i class="material-icons">insights</i></h4><h4>Overview</h4></a>
								</div>
							</li>
							...
							<li>
								<div class= "active-rectangle">
									<a href="https://mtromano.github.io/analyticsmedvrtest/suggestions.php" class="active"><h4><i class="material-symbols-outlined">comment</i></h4><h4>Suggestions</h4></a>
								</div>
							</li>	
						</ul>	
				</div>
